    ...
    return docInfo ? (
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border border-[#ADADAD] rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    {docInfo.reviewCount > 0 && (
                        <p className='text-yellow-500 font-medium mt-2'>★ {docInfo.averageRating} <span className='text-gray-500 text-sm'>({docInfo.reviewCount} reviews)</span></p>
                    )}
                </div>
            </div>
            ...
            <div className='mt-10 mb-10'>
                <p className='text-lg font-medium text-[#262626] border-b pb-2'>Patient Reviews</p>
                {reviews.length === 0 && <p className='text-sm text-gray-500 mt-3'>No reviews yet.</p>}
                <div className='mt-3 flex flex-col gap-4'>
                    {reviews.map((review, index) => (
                        <div key={index} className='border rounded-lg p-4'>
                            <div className='flex items-center justify-between'>
                                <p className='font-medium text-[#262626]'>{review.userName}</p>
